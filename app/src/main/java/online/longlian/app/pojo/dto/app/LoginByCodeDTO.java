...
public class LoginByCodeDTO {
    ...
    @Pattern(regexp = PatternConstants.EMAIL_CODE_PATTERN, message = "验证码必须是6位字母或数字")
    @Schema(description = "6位字母或数字验证码", example = "A1B2C3", requiredMode = Schema.RequiredMode.REQUIRED)
    private String code;
}
