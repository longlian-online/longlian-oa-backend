...
INSERT INTO app_user (id, username, password, nickname, email, avatar_file_id, default_org_id, status, created_at, updated_at, deleted_at) VALUES (1, 'user', '$2a$10$s2suXXpI/zDLdB1Tctb/yuLVUe4LJeMTmGA.swToRG/vVy5aDqPSG', 'user', '123456@qq.com', NULL, 0, 1, '2026-06-10 00:00:00', '2026-06-10 00:00:00', NULL);
-- 开发环境初始化数据（仅用于本地开发，不纳入版本化迁移）
